package com.youke.pedrapapeltesoura;
...
public class MainActivity extends AppCompatActivity {
    ...
    /*
    criando os métodos de escolha do usuário, devem ser público para serem vistos pelo app
    o método verificar ganhador informa ao app a escolha do usuário e compara com a escolha
    aleatória do aplicativo
    */
